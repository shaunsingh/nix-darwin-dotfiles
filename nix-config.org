...
Install Nix. I have it setup for multi-user, but you can remove the =--daemon= if you want a single user install
    #+begin_src bash :comments both :tangle "./extra/install.sh" :shebang "#!/bin/bash"
...
#+begin_src bash :comments both :tangle "./extra/nix-install.sh" :shebang "#!/bin/bash"
...
#+begin_src css :comments both :tangle "./configs/userChrome.css"
/*
...
#+begin_src nix :comments both :tangle "./modules/editors.nix"
...
#+include: "./configs/hammerspoon/init.lua" src lua
*** Hhtwm
...
#+include: "./configs/hammerspoon/hhtwm/init.lua" src lua
#+include: "./configs/hammerspoon/hhtwm/layouts.lua" src lua
*** Plugins
With that, we need the =caffiene= plugin, which this file handles configuring
#+include: "./configs/hammerspoon/plugins/init.lua" src lua
*** Bindings
No use having the logic for a WM if we can't use it. lets define some bindings to help with that
#+include: "./configs/hammerspoon/bindings/init.lua" src lua
#+include: "./configs/hammerspoon/bindings/grid.lua" src lua
#+include: "./configs/hammerspoon/bindings/hotkeys.lua" src lua
#+include: "./configs/hammerspoon/bindings/tiling.lua" src lua

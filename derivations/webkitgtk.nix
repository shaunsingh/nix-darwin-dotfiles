  ...
  stdenv.mkDerivation rec {
    ...
    patches =
      lib.optionals stdenv.isLinux [
        (substituteAll {
          src = ../patches/fix-bubblewrap-paths.patch;
          inherit (builtins) storeDir;
          inherit (addOpenGLRunpath) driverLink;
        })

        ../patches/libglvnd-headers.patch

        # Hardcode path to WPE backend
        # https://github.com/NixOS/nixpkgs/issues/110468
        (substituteAll {
          src = ../patches/fdo-backend-path.patch;
          wpebackend_fdo = libwpe-fdo;
        })
      ]
      ++ [
        ../patches/0001-Fix-build-without-opengl-or-es.patch

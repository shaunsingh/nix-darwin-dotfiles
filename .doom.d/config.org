...
#+begin_src elisp
;;fonts
(setq doom-font (font-spec :family "ttf-fira-code" :size 14 :weight 'light)
      doom-big-font (font-spec :family "ttf-fira-code" :size 20 :weight 'light)
      doom-variable-pitch-font (font-spec :family "ttf-roboto-mono" :size 15 :weight 'Regular)
      doom-unicode-font (font-spec :family "ttf-fira-code":weight 'light)
      ivy-posframe-font (font-spec :family "ttf-fira-code" :size 14.5 :weight 'light)
      doom-serif-font (font-spec :family "ttf-roboto-mono" :weight 'Regular))
#+end_src

For mixed pitch, I would go with something proportional. +I like alegreya, so lets go with that+ actually I decided that I have a deep hatred of proportional fonts and went with Menlo anyways
...
;;set mixed pitch font
 (after! mixed-pitch
  ...
  ;;(setq variable-pitch-serif-font (font-spec :family "ttf-roboto-mono" :size 14))
  (setq variable-pitch-serif-font (font-spec :family "ttf-roboto-mono" :size 14))
...
#+end_src
Lets use tabnine for completion
#+begin_src elisp
;;(use-package company-tabnine)
;;(add-to-list 'company-backends #'company-tabnine)
#+end_src

Lets also have completion and lsp within src code blocks
#+begin_src elisp
...
I also would like F5 to run file (similar to intellij)
#+begin_src elisp
...
I would also like to export to $LaTeX$ on save, assuming I've exported manually at least once
#+begin_src elisp

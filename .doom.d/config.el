...
;;improve by remembering history
...
;;add the few missing alegreya ligatures
...
;;org font rendering
(custom-set-faces! ;lets make headings bigger
...
(custom-set-faces!
  '(org-document-title :height 1.2));;make titles larger too
(setq org-agenda-deadline-faces;;I like to get scared looking at deadlines
      '((1.001 . error)
        (1.0 . org-warning)
...
(defun locally-defer-font-lock ();;defer the font lock so its less laggy
...
;;let yabai handle frames instead of splits (buggy on native comp)

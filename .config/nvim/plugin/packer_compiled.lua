...
_G.packer_plugins = {
  ...
  ["lsp-rooter.nvim"] = {
    loaded = false,
    needs_bufread = false,
    path = "/Users/shauryasingh/.local/share/nvim/site/pack/packer/opt/lsp-rooter.nvim"
  },
  ["lspkind-nvim"] = {
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-treesitter', 'nvim-colorizer.lua', 'nvim-lspconfig', 'gitsigns.nvim', 'lspkind-nvim', 'indent-blankline.nvim', 'lsp-rooter.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]

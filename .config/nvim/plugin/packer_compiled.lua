...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-lspinstall', 'lspkind-nvim', 'indent-blankline.nvim', 'nvim-colorizer.lua', 'nvim-treesitter', 'plenary.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]

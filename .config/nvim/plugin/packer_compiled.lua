...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'plenary.nvim', 'lspkind-nvim', 'nvim-treesitter', 'nvim-lspinstall', 'nvim-colorizer.lua', 'indent-blankline.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]

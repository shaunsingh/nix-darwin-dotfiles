...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-treesitter', 'nvim-colorizer.lua', 'indent-blankline.nvim', 'lightspeed.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]

...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'indent-blankline.nvim', 'nvim-colorizer.lua', 'nvim-treesitter', 'lightspeed.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]

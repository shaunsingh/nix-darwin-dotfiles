...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'indent-blankline.nvim', 'nvim-treesitter', 'lspkind-nvim', 'nvim-colorizer.lua', 'nvim-lspinstall', 'plenary.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]

...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'plenary.nvim', 'nvim-colorizer.lua', 'nvim-lspinstall', 'indent-blankline.nvim', 'nvim-treesitter', 'lspkind-nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]

...
_G.packer_plugins = {
  ...
  ["dashboard-nvim"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/home/shauryasingh/.local/share/nvim/site/pack/packer/opt/dashboard-nvim"
  },
  ["doom-vibrant.nvim"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/home/shauryasingh/.local/share/nvim/site/pack/packer/opt/doom-vibrant.nvim"
  },
  ["friendly-snippets"] = {
    loaded = false,
    needs_bufread = false,
  ...
  ["lspkind-nvim"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/home/shauryasingh/.local/share/nvim/site/pack/packer/opt/lspkind-nvim"
  },
  ["neoscroll.nvim"] = {
    config = { "\27LJ\2\n@\0\0\3\0\3\0\0066\0\0\0'\2\1\0B\0\2\0029\0\2\0B\0\1\1K\0\1\0\14neoscroll\19plugins.others\frequire\0" },
    loaded = false,
    needs_bufread = false,
    path = "/home/shauryasingh/.local/share/nvim/site/pack/packer/opt/neoscroll.nvim"
  },
  ["nvim-autopairs"] = {
  ...
  ["nvim-bufferline.lua"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/home/shauryasingh/.local/share/nvim/site/pack/packer/opt/nvim-bufferline.lua"
  },
  ["nvim-colorizer.lua"] = {
  ...
  ["nvim-compe"] = {
    ...
    after_files = { "/home/shauryasingh/.local/share/nvim/site/pack/packer/opt/nvim-compe/after/plugin/compe.vim" },
    config = { "\27LJ\2\n-\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\18plugins.compe\frequire\0" },
    loaded = false,
    needs_bufread = false,
    path = "/home/shauryasingh/.local/share/nvim/site/pack/packer/opt/nvim-compe",
    wants = { "LuaSnip" }
  },
  ["nvim-lspconfig"] = {
  ...
  ["plenary.nvim"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/home/shauryasingh/.local/share/nvim/site/pack/packer/opt/plenary.nvim"
  },
  ["popup.nvim"] = {
    load_after = {
      ["plenary.nvim"] = true
    ...
    loaded = false,
    needs_bufread = false,
    path = "/home/shauryasingh/.local/share/nvim/site/pack/packer/opt/popup.nvim"
  },
  sniprun = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/home/shauryasingh/.local/share/nvim/site/pack/packer/opt/sniprun"
  },
  ["telescope-fzf-native.nvim"] = {
    commands = { "Telescope" },
    loaded = false,
    needs_bufread = false,
    path = "/home/shauryasingh/.local/share/nvim/site/pack/packer/opt/telescope-fzf-native.nvim"
  },
  ...
  ["vim-matchup"] = {
    after_files = { "/home/shauryasingh/.local/share/nvim/site/pack/packer/opt/vim-matchup/after/plugin/matchit.vim" },
    loaded = false,
    needs_bufread = true,
    path = "/home/shauryasingh/.local/share/nvim/site/pack/packer/opt/vim-matchup"
  }
}
...
pcall(vim.cmd, [[command! -nargs=* -range -bang -complete=file Telescope lua require("packer.load")({'telescope-media-files.nvim', 'telescope.nvim', 'telescope-fzf-native.nvim'}, { cmd = "Telescope", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args> }, _G.packer_plugins)]])
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-colorizer.lua', 'nvim-treesitter', 'plenary.nvim', 'nvim-lspinstall', 'indent-blankline.nvim', 'lspkind-nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]

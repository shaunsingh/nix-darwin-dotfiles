...
_G.packer_plugins = {
  ["AutoSave.nvim"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/Users/shauryasingh/.local/share/nvim/site/pack/packer/opt/AutoSave.nvim"
  },
  LuaSnip = {
  ...
  ["galaxyline.nvim"] = {
    loaded = true,
    path = "/Users/shauryasingh/.local/share/nvim/site/pack/packer/start/galaxyline.nvim"
  },
  ["gitsigns.nvim"] = {
  ...
  neoformat = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/Users/shauryasingh/.local/share/nvim/site/pack/packer/opt/neoformat"
  },
  ["neoscroll.nvim"] = {
  ...
  ["nvim-base16.lua"] = {
    loaded = true,
    path = "/Users/shauryasingh/.local/share/nvim/site/pack/packer/start/nvim-base16.lua"
  },
  ["nvim-bufferline.lua"] = {
    loaded = true,
  ...
  ["telescope-media-files.nvim"] = {
    loaded = true,
    path = "/Users/shauryasingh/.local/share/nvim/site/pack/packer/start/telescope-media-files.nvim"
  },
  ["telescope.nvim"] = {
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'nvim-colorizer.lua', 'indent-blankline.nvim', 'nvim-treesitter', 'lspkind-nvim', 'nvim-lspconfig'}, { event = "BufRead *" }, _G.packer_plugins)]]

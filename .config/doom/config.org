...
** Keycast
Its nice for +demonstrations+ sike just use it all the time
#+begin_src elisp
(use-package! keycast
...
For now might as well keep it on all the time
#+begin_src elisp
...
**** Grip-mode
I also usually write markdown for github, so its nice to preview it. For this we
can use grip-mode
#+begin_src elisp
...
*** LaTeX
We can use latexmk, as opposed to pdflatex.
#+begin_src elisp
(setq org-latex-pdf-process '("latexmk -f -pdf -%latex -shell-escape -interaction=nonstopmode -output-directory=%o %f"))
#+end_src

And disable auctex, because it gets annoying
#+begin_src elisp

...
_G.packer_plugins = {
  ...
  ["nord.nvim"] = {
    after = { "nvim-treesitter", "nvim-web-devicons", "indent-blankline.nvim" },
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'better-escape.nvim', 'copilot.vim', 'friendly-snippets'}, { event = "InsertEnter *" }, _G.packer_plugins)]]

...
local highlights = {
   ...
   Normal = { fg = nord.nord4_gui, bg = nord.nord0_gui }, -- normal text and background color
   ...
   TSEmphasis = { fg = nord.nord10_gui, style = "bold" }, -- For text to be represented with emphasis.
   TSUnderline = { fg = nord.nord4_gui, style = "underline" }, -- For text to be represented with an underline.
   TSTitle = { fg = nord.nord10_gui }, -- Text that is part of a title.
   TSLiteral = { fg = nord.nord4_gui }, -- Literal text.
   TSURI = { fg = nord.nord14_gui }, -- Any URI like a link or email.        TSAnnotation =
   ...
   DiagnosticUnderlineError = { fg = nord.nord11_gui, style = "underline" }, -- used to underline "Error" diagnostics.
   ...
   DiagnosticUnderlineWarn = { fg = nord.nord15_gui, style = "underline" }, -- used to underline "Warn" diagnostics.
   ...
   DiagnosticUnderlineInfo = { fg = nord.nord10_gui, style = "underline" }, -- used to underline "Info" diagnostics.
   ...
   DiagnosticUnderlineHint = { fg = nord.nord10_gui, style = "underline" }, -- used to underline "Hint" diagnostics.
   ...
   DashboardFooter = { fg = nord.nord14_gui },
   ...
   Underlined = { fg = nord.nord14_gui, style = "underline" }, -- text that stands out, HTML links
   Ignore = { fg = nord.nord1_gui }, -- left blank, hidden
   Error = { fg = nord.nord11_gui }, -- any erroneous construct
   Todo = { fg = nord.nord13_gui, style = "bold,italic" }, -- anything that needs extra attention; mostly the keywords TODO FIXME and XXX
   ...
   markdownH1Delimiter = { fg = nord.nord8_gui, style = "bold" },
   markdownH2Delimiter = { fg = nord.nord11_gui, style = "bold" },
   markdownH3Delimiter = { fg = nord.nord14_gui, style = "bold" },
   ...
   Cursor = { fg = nord.nord4_gui, style = "reverse" }, -- the character under the cursor
   CursorIM = { fg = nord.nord5_gui, style = "reverse" }, -- like Cursor, but used when in IME mode
   Directory = { fg = nord.nord7_gui }, -- directory names (and other special names in listings)
   DiffAdd = { fg = nord.nord14_gui, style = "reverse" }, -- diff mode: Added line
   DiffChange = { fg = nord.nord13_gui, style = "reverse" }, --  diff mode: Changed line
   DiffDelete = { fg = nord.nord11_gui, style = "reverse" }, -- diff mode: Deleted line
   DiffText = { fg = nord.nord15_gui, style = "reverse" }, -- diff mode: Changed text within a changed line
   EndOfBuffer = { fg = nord.nord1_gui },
   ErrorMsg = { fg = nord.none },
   Folded = { fg = nord.nord_3_gui_bright, syle = "italic" },
   ...
   MatchParen = { fg = nord.nord15_gui, style = "bold" },
   ...
   SpellBad = { fg = nord.nord11_gui, style = "italic,undercurl" },
   SpellCap = { fg = nord.nord7_gui, style = "italic,undercurl" },
   SpellLocal = { fg = nord.nord8_gui, style = "italic,undercurl" },
   SpellRare = { fg = nord.nord9_gui, style = "italic,undercurl" },
   ...
   ToolbarButton = { fg = nord.nord4_gui, style = "bold" },
   NormalMode = { fg = nord.nord4_gui, style = "reverse" },
   InsertMode = { fg = nord.nord14_gui, style = "reverse" },
   ReplacelMode = { fg = nord.nord11_gui, style = "reverse" },
   VisualMode = { fg = nord.nord9_gui, style = "reverse" },
   CommandMode = { fg = nord.nord4_gui, style = "reverse" },
...
local function load_highlight(highlight)
   for name, setting in pairs(highlight) do

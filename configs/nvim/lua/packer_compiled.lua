...
local no_errors, error_msg = pcall(function()
   ...
   local package_path_str =
      "/Users/shauryasingh/.cache/nvim/packer_hererocks/2.1.0-beta3/share/lua/5.1/?.lua;/Users/shauryasingh/.cache/nvim/packer_hererocks/2.1.0-beta3/share/lua/5.1/?/init.lua;/Users/shauryasingh/.cache/nvim/packer_hererocks/2.1.0-beta3/lib/luarocks/rocks-5.1/?.lua;/Users/shauryasingh/.cache/nvim/packer_hererocks/2.1.0-beta3/lib/luarocks/rocks-5.1/?/init.lua"
   ...
   _G.packer_plugins = {
      ...
      ["cmp-nvim-lsp"] = {
         after = { "cmp-treesitter", "cmp-rg" },
         after_files = {
            "/Users/shauryasingh/.local/share/nvim/site/pack/packer/opt/cmp-nvim-lsp/after/plugin/cmp_nvim_lsp.lua",
         },
         load_after = {
            ["cmp-nvim-lua"] = true,
         },
      ...
      ["cmp-nvim-lua"] = {
         after = { "cmp-nvim-lsp" },
         after_files = {
            "/Users/shauryasingh/.local/share/nvim/site/pack/packer/opt/cmp-nvim-lua/after/plugin/cmp_nvim_lua.lua",
         },
         load_after = {
            cmp_luasnip = true,
         },
      ...
      ["cmp-path"] = {
         after_files = {
            "/Users/shauryasingh/.local/share/nvim/site/pack/packer/opt/cmp-path/after/plugin/cmp_path.lua",
         },
         load_after = {
            ["cmp-rg"] = true,
         },
      ...
      ["cmp-rg"] = {
         after = { "cmp-path" },
         after_files = {
            "/Users/shauryasingh/.local/share/nvim/site/pack/packer/opt/cmp-rg/after/plugin/cmp-rg.lua",
         },
         load_after = {
            ["cmp-nvim-lsp"] = true,
         },
      ...
      ["cmp-treesitter"] = {
         after_files = {
            "/Users/shauryasingh/.local/share/nvim/site/pack/packer/opt/cmp-treesitter/after/plugin/cmp_treesitter.lua",
         },
         load_after = {
            ["cmp-nvim-lsp"] = true,
         },
      ...
      cmp_luasnip = {
         after = { "cmp-nvim-lua" },
         after_files = {
            "/Users/shauryasingh/.local/share/nvim/site/pack/packer/opt/cmp_luasnip/after/plugin/cmp_luasnip.lua",
         },
         load_after = {
            LuaSnip = true,
         },
      ...
      ["nord.nvim"] = {
         after = { "indent-blankline.nvim", "nvim-web-devicons", "gitsigns.nvim", "nvim-treesitter" },
      ...
      ["nvim-lsp-installer"] = {
         ...
         needs_bufread = false,
         only_cond = false,
         path = "/Users/shauryasingh/.local/share/nvim/site/pack/packer/opt/nvim-lsp-installer",
   ...
   pcall(
      vim.cmd,
      [[command -nargs=* -range -bang -complete=file TZAtaraxis lua require("packer.load")({'TrueZen.nvim'}, { cmd = "TZAtaraxis", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args>, mods = "<mods>" }, _G.packer_plugins)]]
   )
   pcall(
      vim.cmd,
      [[command -nargs=* -range -bang -complete=file TZMinimalist lua require("packer.load")({'TrueZen.nvim'}, { cmd = "TZMinimalist", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args>, mods = "<mods>" }, _G.packer_plugins)]]
   )
   pcall(
      vim.cmd,
   ...
   pcall(
      vim.cmd,
      [[command -nargs=* -range -bang -complete=file TZFocus lua require("packer.load")({'TrueZen.nvim'}, { cmd = "TZFocus", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args>, mods = "<mods>" }, _G.packer_plugins)]]
   )
   ...
   pcall(
      vim.cmd,
      [[command -nargs=* -range -bang -complete=file HopWord lua require("packer.load")({'hop'}, { cmd = "HopWord", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args>, mods = "<mods>" }, _G.packer_plugins)]]
   )
   pcall(
      vim.cmd,
      [[command -nargs=* -range -bang -complete=file HopLine lua require("packer.load")({'hop'}, { cmd = "HopLine", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args>, mods = "<mods>" }, _G.packer_plugins)]]
   )
   pcall(
      vim.cmd,
      [[command -nargs=* -range -bang -complete=file HopChar1 lua require("packer.load")({'hop'}, { cmd = "HopChar1", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args>, mods = "<mods>" }, _G.packer_plugins)]]
   )
   pcall(
      vim.cmd,
      [[command -nargs=* -range -bang -complete=file TSPlayground lua require("packer.load")({'playground'}, { cmd = "TSPlayground", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args>, mods = "<mods>" }, _G.packer_plugins)]]
   )
   pcall(
      vim.cmd,
      [[command -nargs=* -range -bang -complete=file HopPattern lua require("packer.load")({'hop'}, { cmd = "HopPattern", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args>, mods = "<mods>" }, _G.packer_plugins)]]
   )
   pcall(
      vim.cmd,
      [[command -nargs=* -range -bang -complete=file HopChar2 lua require("packer.load")({'hop'}, { cmd = "HopChar2", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args>, mods = "<mods>" }, _G.packer_plugins)]]
   )
   ...
   vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'friendly-snippets', 'nvim-lsp-installer', 'copilot.vim', 'better-escape.nvim'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
   vim.cmd [[au VimEnter * ++once lua require("packer.load")({'packer.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
   time([[Defining lazy-load event autocommands]], false)
   vim.cmd "augroup END"
   vim.cmd [[augroup filetypedetect]]
   time(
      [[Sourcing ftdetect script at: /Users/shauryasingh/.local/share/nvim/site/pack/packer/opt/neorg/ftdetect/norg.vim]],
      true
   )

...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'copilot.vim', 'friendly-snippets', 'better-escape.nvim', 'nvim-lsp-installer'}, { event = "InsertEnter *" }, _G.packer_plugins)]]

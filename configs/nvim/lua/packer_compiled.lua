...
_G.packer_plugins = {
  ...
  ["nord.nvim"] = {
    after = { "gitsigns.nvim", "nvim-treesitter", "indent-blankline.nvim", "nvim-web-devicons", "which-key.nvim" },
    loaded = true,
    only_config = true
  },
  ["nui.nvim"] = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-rg", "cmp-path", "LuaSnip", "cmp-nvim-lua", "cmp-treesitter", "cmp-nvim-lsp" },

...
_G.packer_plugins = {
  ...
  ["nord.nvim"] = {
    after = { "nvim-web-devicons", "gitsigns.nvim", "nvim-treesitter", "indent-blankline.nvim" },
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'friendly-snippets', 'better-escape.nvim', 'copilot.vim', 'nvim-lsp-installer'}, { event = "InsertEnter *" }, _G.packer_plugins)]]

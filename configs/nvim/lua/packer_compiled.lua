...
local no_errors, error_msg = pcall(function()
   ...
   _G.packer_plugins = {
      ...
      ["nord.nvim"] = {
         after = { "nvim-web-devicons", "nvim-treesitter", "gitsigns.nvim", "indent-blankline.nvim" },
   ...
   vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-lsp-installer', 'better-escape.nvim', 'friendly-snippets', 'copilot.vim'}, { event = "InsertEnter *" }, _G.packer_plugins)]]

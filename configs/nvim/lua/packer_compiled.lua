...
_G.packer_plugins = {
  ...
  ["nord.nvim"] = {
    after = { "gitsigns.nvim", "indent-blankline.nvim", "nvim-web-devicons", "nvim-treesitter", "which-key.nvim" },
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'better-escape.nvim', 'nvim-lsp-installer', 'copilot.vim', 'friendly-snippets'}, { event = "InsertEnter *" }, _G.packer_plugins)]]

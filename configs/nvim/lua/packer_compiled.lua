...
_G.packer_plugins = {
  ...
  ["nord.nvim"] = {
    after = { "nvim-treesitter", "nvim-web-devicons", "gitsigns.nvim", "indent-blankline.nvim" },
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'friendly-snippets', 'better-escape.nvim', 'nvim-lsp-installer', 'copilot.vim'}, { event = "InsertEnter *" }, _G.packer_plugins)]]

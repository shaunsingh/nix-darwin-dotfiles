...
_G.packer_plugins = {
  ...
  ["nord.nvim"] = {
    after = { "nvim-treesitter", "gitsigns.nvim", "indent-blankline.nvim", "nvim-web-devicons" },
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'copilot.vim', 'friendly-snippets', 'nvim-lsp-installer', 'better-escape.nvim'}, { event = "InsertEnter *" }, _G.packer_plugins)]]

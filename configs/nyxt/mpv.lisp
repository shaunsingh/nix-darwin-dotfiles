...
(defmethod url-sources-no-suggestions ((buffer buffer) return-actions)
  (append
   (list (make-instance 'nyxt::new-url-or-search-source :actions-on-return return-actions)
         (make-instance 'nyxt::global-history-source :actions-on-return return-actions)
         (make-instance 'nyxt::search-engine-url-source :actions-on-return return-actions))

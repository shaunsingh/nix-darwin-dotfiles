...
*** Maxima
Sometimes I need to calculate stuff past what emacs-calc can do. I also prefer
a "regular" method entry of entry when not doing quick calculations, which RPN
excels in.
#+begin_src elisp
(use-package maxima
  :commands maxima
...
Along with that, we want to insert and render latex images within org-mode,
using org-babel.
#+begin_src elisp
(after! org
